...
namespace ETrade.Dal.Migrations
{
    ...
    [Migration("20221103112214_error")]
    partial class error
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ETrade.Entity.Concretes.Cities", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ETrade.Entity.Concretes.Counties", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ETrade.Entity.Concretes.Counties", b =>
                {
                    b.HasOne("ETrade.Entity.Concretes.Cities", "Cities")
                        .WithMany("Counties")
            ...
            modelBuilder.Entity("ETrade.Entity.Concretes.Users", b =>
                {
                    b.HasOne("ETrade.Entity.Concretes.Counties", "Counties")
                        .WithMany("Users")
